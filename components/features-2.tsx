      ...
      <div className="@container mx-auto max-w-5xl px-6">
        <div className="text-center">
          ...
          {/* <h3 className="mt-2 text-lg font-medium ">
            Instant answers, fewer calls.
          </h3> */}
          <p className="mt-4">
            Instant answers automatically, so your front desk doesn’t have to.
          </p>
        </div>
        ...
        <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 [--color-background:var(--color-muted)] [--color-card:var(--color-muted)] *:text-center md:mt-16 dark:[--color-muted:var(--color-zinc-900)]">
          ...
          <Card className="group border-0 shadow-none">
            ...
            <CardContent>
              <p className="mt-3 text-sm">
                Decide what patients can ask, how answers are shown, and when
          ...
          <Card className="group border-0 shadow-none">
            <CardHeader className="pb-3">
              ...
              <h3 className="mt-6 font-medium">Powered By OpenAI</h3>
            </CardHeader>
